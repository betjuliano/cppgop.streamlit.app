...
# Aplicar estilo personalizado com tons de azul e branco
st.markdown("""
<style>
    :root {
        --primary-color: #0A4C92;
        --secondary-color: #1A75D2;
        --accent-color: #5DA9E9;
        --light-color: #EBF5FF;
        --white-color: #FFFFFF;
        --dark-color: #003366;
    ...
    .status-aprovado_coordenacao {
        background-color: #17a2b8;
        color: var(--white-color);
    }
    
    .status-aprovado_colegiado {
...
# Interface principal após login
    ...
    # Barra superior
    st.markdown(f'<div class="user-info">Usuário: {st.session_state.user["username"]}</div>', unsafe_allow_html=True)
    
    # Sidebar para navegação
    with st.sidebar:
        st.markdown('<div class="sub-header">Menu</div>', unsafe_allow_html=True)
    ...
    # Página de Aproveitamentos
        ...
        st.markdown('<div class="main-header">Aproveitamentos de Disciplinas</div>', unsafe_allow_html=True)
